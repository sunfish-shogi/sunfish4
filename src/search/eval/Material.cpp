...
Score promotionScores[PieceNumber::Num] = {
  ...
  /*  7 */ 0,
  /*  8 */ material::Tokin - material::Pawn,
  /*  9 */ material::ProLance - material::Lance,
  /* 10 */ material::ProKnight - material::Knight,
  /* 11 */ material::ProSilver - material::Silver,
  /* 12 */ 0,
  /* 13 */ material::Horse - material::Bishop,
  /* 14 */ material::Dragon - material::Rook,
  /* 15 */ 0,
  ...
  /* 23 */ 0,
  /* 24 */ material::Tokin - material::Pawn,
  /* 25 */ material::ProLance - material::Lance,
  /* 26 */ material::ProKnight - material::Knight,
  /* 27 */ material::ProSilver - material::Silver,
  /* 28 */ 0,
  /* 29 */ material::Horse - material::Bishop,
  /* 30 */ material::Dragon - material::Rook,
};
