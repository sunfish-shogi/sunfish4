...
void sortMoves(Moves& moves, const Position& position) {
...
TEST(MoveGeneratorTest, test) {
...

  {
    ...
    ASSERT_EQ(Move(Square::s33(), Square::s24(), true),  caps[4]);
    ASSERT_EQ(Move(Square::s33(), Square::s32(), true),  caps[5]);
    ASSERT_EQ(Move(Square::s33(), Square::s42(), true),  caps[6]);
    ASSERT_EQ(Move(Square::s33(), Square::s44(), true),  caps[7]);
    ASSERT_EQ(Move(Square::s33(), Square::s44(), false), caps[8]);
    ASSERT_EQ(Move(Square::s72(), Square::s61(), true),  caps[9]);
    ASSERT_EQ(Move(Square::s72(), Square::s71(), true),  caps[10]);
    ASSERT_EQ(Move(Square::s72(), Square::s81(), true),  caps[11]);
    ASSERT_EQ(Move(Square::s72(), Square::s83(), true),  caps[12]);
    ASSERT_EQ(Move(Square::s72(), Square::s83(), false), caps[13]);
    ASSERT_EQ(Move(Square::s22(), Square::s12(), false), caps[14]);
    ASSERT_EQ(Move(Square::s35(), Square::s13(), true),  caps[15]);
    ASSERT_EQ(Move(Square::s35(), Square::s44(), false), caps[16]);
    ASSERT_EQ(Move(Square::s63(), Square::s43(), true),  caps[17]);
    ASSERT_EQ(Move(Square::s63(), Square::s53(), true),  caps[18]);
    ASSERT_EQ(Move(Square::s63(), Square::s61(), true),  caps[19]);
    ASSERT_EQ(Move(Square::s63(), Square::s62(), true),  caps[20]);
    ASSERT_EQ(Move(Square::s63(), Square::s64(), true),  caps[21]);
    ASSERT_EQ(Move(Square::s63(), Square::s65(), true),  caps[22]);
    ASSERT_EQ(Move(Square::s63(), Square::s66(), true),  caps[23]);
    ASSERT_EQ(Move(Square::s63(), Square::s73(), true),  caps[24]);
    ASSERT_EQ(Move(Square::s63(), Square::s83(), true),  caps[25]);
    ASSERT_EQ(Move(Square::s93(), Square::s75(), false), caps[26]);
    ...
    ASSERT_EQ(Move(Square::s33(), Square::s24(), false), nocaps[9]);
    ASSERT_EQ(Move(Square::s33(), Square::s32(), false), nocaps[10]);
    ASSERT_EQ(Move(Square::s33(), Square::s42(), false), nocaps[11]);
    ASSERT_EQ(Move(Square::s72(), Square::s61(), false), nocaps[12]);
    ASSERT_EQ(Move(Square::s72(), Square::s71(), false), nocaps[13]);
    ASSERT_EQ(Move(Square::s72(), Square::s81(), false), nocaps[14]);
    ASSERT_EQ(Move(Square::s22(), Square::s11(), false), nocaps[15]);
    ASSERT_EQ(Move(Square::s22(), Square::s21(), false), nocaps[16]);
    ASSERT_EQ(Move(Square::s22(), Square::s23(), false), nocaps[17]);
    ASSERT_EQ(Move(Square::s22(), Square::s31(), false), nocaps[18]);
    ASSERT_EQ(Move(Square::s22(), Square::s32(), false), nocaps[19]);
    ASSERT_EQ(Move(Square::s35(), Square::s17(), false), nocaps[20]);
    ASSERT_EQ(Move(Square::s35(), Square::s24(), false), nocaps[21]);
    ASSERT_EQ(Move(Square::s35(), Square::s26(), false), nocaps[22]);
    ASSERT_EQ(Move(Square::s35(), Square::s46(), false), nocaps[23]);
    ASSERT_EQ(Move(Square::s59(), Square::s48(), false), nocaps[24]);
    ASSERT_EQ(Move(Square::s59(), Square::s49(), false), nocaps[25]);
    ASSERT_EQ(Move(Square::s59(), Square::s58(), false), nocaps[26]);
    ASSERT_EQ(Move(Square::s59(), Square::s68(), false), nocaps[27]);
    ASSERT_EQ(Move(Square::s59(), Square::s69(), false), nocaps[28]);
    ASSERT_EQ(Move(Square::s91(), Square::s81(), false), nocaps[29]);
    ASSERT_EQ(Move(Square::s91(), Square::s92(), false), nocaps[30]);
    ASSERT_EQ(Move(Square::s93(), Square::s71(), false), nocaps[31]);
    ASSERT_EQ(Move(Square::s93(), Square::s82(), false), nocaps[32]);
    ASSERT_EQ(Move(Square::s93(), Square::s84(), false), nocaps[33]);
    ASSERT_EQ(Move(Square::s93(), Square::s92(), false), nocaps[34]);
    ASSERT_EQ(Move(Square::s93(), Square::s94(), false), nocaps[35]);
  }

  {
    ...
    ASSERT_EQ(Move(Square::s37(), Square::s26(), true),  caps[4]);
    ASSERT_EQ(Move(Square::s37(), Square::s38(), true),  caps[5]);
    ASSERT_EQ(Move(Square::s37(), Square::s46(), true),  caps[6]);
    ASSERT_EQ(Move(Square::s37(), Square::s46(), false), caps[7]);
    ASSERT_EQ(Move(Square::s37(), Square::s48(), true),  caps[8]);
    ASSERT_EQ(Move(Square::s78(), Square::s69(), true),  caps[9]);
    ASSERT_EQ(Move(Square::s78(), Square::s79(), true),  caps[10]);
    ASSERT_EQ(Move(Square::s78(), Square::s87(), true),  caps[11]);
    ASSERT_EQ(Move(Square::s78(), Square::s87(), false), caps[12]);
    ASSERT_EQ(Move(Square::s78(), Square::s89(), true),  caps[13]);
    ASSERT_EQ(Move(Square::s28(), Square::s18(), false), caps[14]);
    ASSERT_EQ(Move(Square::s35(), Square::s17(), true),  caps[15]);
    ASSERT_EQ(Move(Square::s35(), Square::s46(), false), caps[16]);
    ASSERT_EQ(Move(Square::s67(), Square::s47(), true),  caps[17]);
    ASSERT_EQ(Move(Square::s67(), Square::s57(), true),  caps[18]);
    ASSERT_EQ(Move(Square::s67(), Square::s64(), true),  caps[19]);
    ASSERT_EQ(Move(Square::s67(), Square::s65(), true),  caps[20]);
    ASSERT_EQ(Move(Square::s67(), Square::s66(), true),  caps[21]);
    ASSERT_EQ(Move(Square::s67(), Square::s68(), true),  caps[22]);
    ASSERT_EQ(Move(Square::s67(), Square::s69(), true),  caps[23]);
    ASSERT_EQ(Move(Square::s67(), Square::s77(), true),  caps[24]);
    ASSERT_EQ(Move(Square::s67(), Square::s87(), true),  caps[25]);
    ASSERT_EQ(Move(Square::s97(), Square::s75(), false), caps[26]);
    ...
    ASSERT_EQ(Move(Square::s37(), Square::s26(), false), nocaps[9]);
    ASSERT_EQ(Move(Square::s37(), Square::s38(), false), nocaps[10]);
    ASSERT_EQ(Move(Square::s37(), Square::s48(), false), nocaps[11]);
    ASSERT_EQ(Move(Square::s78(), Square::s69(), false), nocaps[12]);
    ASSERT_EQ(Move(Square::s78(), Square::s79(), false), nocaps[13]);
    ASSERT_EQ(Move(Square::s78(), Square::s89(), false), nocaps[14]);
    ASSERT_EQ(Move(Square::s28(), Square::s19(), false), nocaps[15]);
    ASSERT_EQ(Move(Square::s28(), Square::s27(), false), nocaps[16]);
    ASSERT_EQ(Move(Square::s28(), Square::s29(), false), nocaps[17]);
    ASSERT_EQ(Move(Square::s28(), Square::s38(), false), nocaps[18]);
    ASSERT_EQ(Move(Square::s28(), Square::s39(), false), nocaps[19]);
    ASSERT_EQ(Move(Square::s35(), Square::s13(), false), nocaps[20]);
    ASSERT_EQ(Move(Square::s35(), Square::s24(), false), nocaps[21]);
    ASSERT_EQ(Move(Square::s35(), Square::s26(), false), nocaps[22]);
    ASSERT_EQ(Move(Square::s35(), Square::s44(), false), nocaps[23]);
    ASSERT_EQ(Move(Square::s51(), Square::s41(), false), nocaps[24]);
    ASSERT_EQ(Move(Square::s51(), Square::s42(), false), nocaps[25]);
    ASSERT_EQ(Move(Square::s51(), Square::s52(), false), nocaps[26]);
    ASSERT_EQ(Move(Square::s51(), Square::s61(), false), nocaps[27]);
    ASSERT_EQ(Move(Square::s51(), Square::s62(), false), nocaps[28]);
    ASSERT_EQ(Move(Square::s99(), Square::s89(), false), nocaps[29]);
    ASSERT_EQ(Move(Square::s99(), Square::s98(), false), nocaps[30]);
    ASSERT_EQ(Move(Square::s97(), Square::s79(), false), nocaps[31]);
    ASSERT_EQ(Move(Square::s97(), Square::s86(), false), nocaps[32]);
    ASSERT_EQ(Move(Square::s97(), Square::s88(), false), nocaps[33]);
    ASSERT_EQ(Move(Square::s97(), Square::s96(), false), nocaps[34]);
    ASSERT_EQ(Move(Square::s97(), Square::s98(), false), nocaps[35]);
  }
